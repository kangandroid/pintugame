...
import com.kings.pintugame.utils.DensityUtils;
...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(DensityUtils.dp2px( 2));
		mOutlinePaint.setColor(getResources().getColor(R.color.lightgreen300));
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = DensityUtils.dp2px( 5);
